...
nrmse <- read.table("../data/pab1_rf_reg_5foldCV_5repeats_nrmse.txt", header = TRUE, sep = "\t")
...
dfs <- read.table("../data/pab1_re_reg_ntm6-stop-ntp9_padj_BH.txt", header = TRUE, sep = "\t")
...
# P-site codon -------------------------------------
dfpc <- read.table("../data/pab1_re_reg_codon_m01_padj_BH.txt", header = TRUE, sep = "\t")
